  ...
  <div class="space-y-6">
    <div class="breadcrumbs text-sm text-base-content/60">
      <ul>
        ...
        <li><NuxtLink :to="`/projects/${currentProject.id}`">{{ currentProject.code }}</NuxtLink></li>
        <li>Legal Workspace</li>
      </ul>
    </div>
        ...
        <div class="card-body p-5 space-y-4">
          ...
          <div>
            ...
            <div class="space-y-2">
              ...
              <button class="btn btn-ghost btn-sm gap-1" @click="openDeliverableModal">
              ...
              <table class="table table-sm w-full">
                ...
                <tfoot>
                  <tr class="border-t-2 border-base-300">
                    <td colspan="2">
                      <button class="btn btn-ghost btn-sm gap-1" @click="openPenawaranItemModal">
    ...
    <WorkspaceModal :open="activeModal === 'penawaranItem'" title="Tambah Item Penawaran" kicker="Penawaran" @close="closeModal">
      <div class="grid gap-4">
        <div class="form-control w-full">
          ...
          <input type="text" v-model="modalDraft.itemDesc" class="input input-bordered w-full" placeholder="e.g. Backend API Development..." />
        </div>
        <div class="form-control w-full">
    ...
    <WorkspaceModal :open="activeModal === 'clause'" title="Tambah Pasal Perjanjian" kicker="Agreement" @close="closeModal">
      <div class="grid gap-4">
        <div class="form-control w-full">
          ...
          <input type="text" v-model="modalDraft.clauseTitle" class="input input-bordered w-full" placeholder="Judul pasal..." />
        </div>
        <div class="form-control w-full">
...
const openDeliverableModal = () => {
  closeModal()
  activeModal.value = 'deliverable'
}

const saveDeliverable = () => {
  if (modalDraft.deliverable.trim()) {
    docs.proposal.deliverables.push(modalDraft.deliverable.trim())
  }
  closeModal()
}

const openPenawaranItemModal = () => {
  closeModal()
  activeModal.value = 'penawaranItem'
}

const savePenawaranItem = () => {
  if (modalDraft.itemDesc.trim()) {
    docs.penawaran.items.push({ description: modalDraft.itemDesc.trim(), price: Number(modalDraft.itemPrice) || 0 })
  }
  closeModal()
}
...
const saveClause = () => {
  if (modalDraft.clauseTitle.trim()) {
...
const docs = reactive({
  ...
  agreement: {
    ...
    partyTwo: {
      name: currentProject.value.clientName,
      address: '',
      pic: '',
    },
    clauses: [
